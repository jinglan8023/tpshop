<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/data/wwwroot/default/9.4/public/../application/index/view/order/order.html";i:1547808276;s:78:"/data/wwwroot/default/9.4/public/../application/index/view/layout/layout3.html";i:1539953286;s:75:"/data/wwwroot/default/9.4/public/../application/index/view/public/top3.html";i:1547608502;s:77:"/data/wwwroot/default/9.4/public/../application/index/view/public/footer.html";i:1537340772;}*/ ?>
...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <div class="price_a"><a href="<?php echo url('car/buycarone'); ?>">去购物车结算</a></div>
            <!--End 购物车已登录 End-->
        </div>
    </div>
</div>
...
<div class="i_bg">
    ...
    <div class="content mar_20">
        <div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                ...
                <?php $sum=0.00;$score=0;if(is_array($car) || $car instanceof \think\Collection || $car instanceof \think\Paginator): $i = 0; $__LIST__ = $car;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;
                $sum+=$v['sku_price']*$v['buy_number'];

               ?>
                <tr class="car_tr">
                    <td>
                        <div class="c_s_img"><img src="/<?php echo $v['sku_img']; ?>" width="73" height="73" /></div>
                        <?php echo $v['sku_name']; ?>
                    </td>
                    <td align="center"><?php echo formatMoney($v['sku_price']); ?></td>
                    <td align="center"><?php echo $v['buy_number']; ?></td>
                    <td align="center" style="color:#ff4e00;">￥<?php echo formatMoney($v['sku_price']*$v['buy_number']); ?></td>
                    <td>积分*件数</td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <tr>
                    <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                        商品总价：￥<?php echo formatMoney($sum); ?>； 返还积分 777R
                    </td>
                </tr>
            </table>
            ...
            <div class="two_t">
                <span class="fr">
                   <button><a href="<?php echo url('UserAddress/address'); ?>">新增收货地址</a></button>
                </span>收货人信息
            </div>
            <?php if($addressInfo == []): ?>
            ...
            <div style="height:300px;overflow-y:scroll;">
                ...
                <table border="0" class="peo_tab" style="width:1110px;margin-top:10px;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            <input type="radio" checked name="address_id" value="<?php echo $v['address_id']; ?>">
                        </td>
                        <td>
                            <?php echo $v['province']; ?><?php echo $v['city']; ?><?php echo $v['district']; ?><?php echo $v['address_detail']; ?><?php echo $v['address_man']; ?><?php echo $v['address_tel']; ?>  收
                        </td>
                        <td>
                            <a href="<?php echo url('UserAddress/addressUpdate'); ?>?address_id=<?php echo $v['address_id']; ?>">修改</a>
                        </td>
                    </tr>
                </table>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td align="right">
                        该订单完成后，您将获得 <font color="#ff4e00"><?php echo $score; ?></font> 积分<br />
                ...
                <tr height="70">
                    <td align="right">
                        <b style="font-size:14px;">应付款金额：
                            <span style="font-size:22px; color:#ff4e00;">￥<?php echo formatMoney($sum); ?></span>
                        </b>
                    </td>
                </tr>
                <tr height="70">
    ...
    <script type="text/javascript">
        ...
        $('.submit').click(function() {
            ...
            //alert(address_id);
            $.ajax({
                url: "<?php echo url('Order/submitOrder'); ?>",
                type: 'post',
                dataType: 'json',
                ...
                //console.log(json_info);return false;
                    ...
                    var url="<?php echo url('Order/createSuccess',['order_no'=>'__ORDER_NO__']); ?>";
