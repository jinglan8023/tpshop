<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/data/wwwroot/default/9.4/public/../application/index/view/login/login.html";i:1547806095;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            $('#btn').click(function(){
                ...
                $.post(
                    ...
                    ,function(msg){
                        ...
                        if(msg.code==1){
                            var refer="<?php echo isset($_GET['refer'])?$_GET['refer']:''?>";
                            var car_id="<?php echo isset($_GET['car_id'])?$_GET['car_id']:''?>";
                            if(refer){
                                window.location.href=refer+'?car_id='+car_id;
