<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"/data/wwwroot/default/9.4/public/../application/index/view/product/productlist.html";i:1542588018;s:78:"/data/wwwroot/default/9.4/public/../application/index/view/layout/layout3.html";i:1539953286;s:75:"/data/wwwroot/default/9.4/public/../application/index/view/public/top3.html";i:1547861107;s:76:"/data/wwwroot/default/9.4/public/../application/index/view/product/list.html";i:1546996413;s:77:"/data/wwwroot/default/9.4/public/../application/index/view/public/footer.html";i:1537340772;}*/ ?>
...
<div class="i_bg">
	<div class="postion">
    	<span class="fl">
            ...
            <?php if($three != []): ?>
                <?php echo $three['cate_name']; endif; ?>
    	</span>
    ...
    <div class="content mar_10">
    	<table border="0" class="choice" style="width:100%; font-family:'宋体'; margin:0 auto;" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="70">&nbsp; 品牌：</td>
            <td class="td_a brand">
            <?php if(is_array($brandArr) || $brandArr instanceof \think\Collection || $brandArr instanceof \think\Paginator): $i = 0; $__LIST__ = $brandArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <a href="javascript:;" brand_id="<?php echo $vo['brand_id']; ?>"><?php echo $vo['brand_name']; ?></a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </td>
          </tr>
    ...
    <script text="text/javascript">
        ...
        function getAjaxPage(type,order_field,order_type){
           ...
           var brand_id=$('.brand').find('.now').attr('brand_id');
            ...
            if(type==1){
                $.ajax({
                    url:"<?php echo url('Product/showMoneySelect',['cate_id'=>request()->param('cate_id')]); ?>",
                    data:data,
                    type:'post',
                    dataType:'json',
            ...
            //ajax 请求筛选对应品牌下边的商品
            $.ajax({
                url:"<?php echo url('Product/productList',['cate_id'=>request()->param('cate_id')]); ?>",
                data:data,
                type:'post',
                dataType:'json',
                success:function(message){
