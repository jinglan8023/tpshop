<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/data/wwwroot/default/9.4/public/../application/index/view/product/detail.html";i:1546942438;s:78:"/data/wwwroot/default/9.4/public/../application/index/view/layout/layout3.html";i:1539953286;s:75:"/data/wwwroot/default/9.4/public/../application/index/view/public/top3.html";i:1547861107;s:77:"/data/wwwroot/default/9.4/public/../application/index/view/public/footer.html";i:1537340772;}*/ ?>
...
<div class="top">
    ...
    <div class="i_car">
        <div class="car_t"><a href="<?php echo url('car/carlist'); ?>">购物车 [ <span id="topnum"></span> ]</a></div>
        <div class="car_bg">
            ...
            <div style="height: 200px;overflow-y: auto;">
                <ul class="cars">
                    ...
                    <li class="aprice">
                        <input type="hidden" class="subtotal" value="<?php echo $v['sku_price']*$v['buy_number']; ?>">
                        <div class="img"><a href="#"><img src="__ROOT__/<?php echo $v['sku_img']; ?>" width="58" height="58" /></a></div>
                        <div class="name"><a href="#"><?php echo $v['sku_name']; ?></a></div>
                        <div class="price"><font color="#ff4e00">￥<?php echo $v['sku_price']; ?></font> X<?php echo $v['buy_number']; ?></div>
                    </li>
            ...
            <div class="price_a"><a href="<?php echo url('car/carlist'); ?>">去购物车结算</a></div>
            <!--End 购物车已登录 End-->
        </div>
    </div>
</div>
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                ...
                                <div class="zj_l_c">
                                    ...
                                    <a href="<?php echo url('Product/productDetail',['cate_id'=>$vvv['cate_id']]); ?>"><?php echo $vvv['cate_name']; ?></a>|
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
...
<div class="i_bg">
    <div class="postion">
        <span class="fl">
            全部>
            <?php if($one != []): ?><?php echo $one['cate_name']; endif; ?> >
            <?php if($two != []): ?> <?php echo $two['cate_name']; endif; ?>>
            <?php if($three != []): ?><?php echo $three['cate_name']; endif; ?>>
            <?php echo $goods['goods_name']; ?>
        </span>
    </div>
    <div class="content">
        <?php
        $small=array_filter(explode('|',$goods['goods_small_imgs']));
        $big=array_filter(explode('|',$goods['goods_big_imgs']));
        ?>
        <div id="tsShopContainer">
            <div id="tsImgS">
                <a href="/<?php echo $big['0']; ?>" title="Images" class="MagicZoom" id="MagicZoom">
                    <img src="/<?php echo $big['0']; ?>" width="390" height="390" />
                </a>
            </div>
            <div id="tsPicContainer">
                ...
                <div id="tsImgSCon">
                    <ul>
                        <?php if(is_array($small) || $small instanceof \think\Collection || $small instanceof \think\Paginator): $i = 0; $__LIST__ = $small;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <li onclick="showPic(<?php echo $key; ?>)" rel="MagicZoom" class="tsSelectImg">
                                <img src="/<?php echo $v; ?>"
                                     tsImgS="" width="79" height="79" />
                            </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            <div class="des_name">
                <p><?php echo $goods['sku_name']; ?></p>
                <?php echo $goods['sku_name']; ?>
            </div>
            <div class="des_price">
                本店价格：<b>¥<?php echo formatSale($goods['sku_price']); ?></b><br />
                消费积分：<span><?php echo $goods['goods_score']; ?>R</span>
                库存：<span id="stock" style="display:none;"><?php echo $goods['sku_stock']; ?></span>
            </div>
            ...
            <div class="des_choice">
                <span class="fl" sale_id="<?php echo $v['sale_attr_id']; ?>"><?php echo $v['sale_attr_name']; ?>：</span>
                <ul>
                    <?php if(is_array($v['son']) || $v['son'] instanceof \think\Collection || $v['son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;
        ...
        <div class="s_brand">
            ...
            <div class="s_brand_c"><a href="__STATIC__/index/#">进入品牌专区</a></div>
        </div>
    </div>
    <div class="content mar_20">
        <div class="l_history">
            <div class="fav_t">浏览记录</div>
            <ul>
            <!--登陆后的浏览记录可以展示-->
                <?php if(is_array($history) || $history instanceof \think\Collection || $history instanceof \think\Paginator): $i = 0; $__LIST__ = $history;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <li>
                        <div class="img">
                            <a href="#">
                                <img src="/<?php echo $v['goods_img']; ?>" width="185" height="162" />
                            </a>
                        </div>
                        <div class="name"><a href="#"><?php echo $v['goods_name']; ?></a></div>
                        <div class="price">
                            <font>￥<span><?php echo formatMoney($v['goods_selfprice']); ?></span></font> &nbsp; 18R
                        </div>
                    </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        ...
        <div class="l_list">
            <div class="des_border">
                ...
                <div class="team_list">
                    <div class="img"><a href="__STATIC__/index/#"><img src="__STATIC__/index/images/mat_2.jpg" width="160" height="140" /></a></div>
                    <div class="name"><a href="__STATIC__/index/#">香奈儿邂逅清新淡香水50ml</a></div>
                    <div class="price">
            ...
            <div class="des_border">
                <div class="des_tit">
                    <ul>
                        <li class="current"><a href="__STATIC__/index/#p_attribute">商品属性</a></li>
                        <li><a href="#">商品详情</a></li>
                        <li><a href="#">商品评论</a></li>
                    </ul>
                </div>
                <div class="des_con" id="p_attribute">
                    <table border="0" align="center" style="width:100%; font-family:'宋体'; margin:10px auto;" cellspacing="0" cellpadding="0">
                        <?php if(is_array($basic) || $basic instanceof \think\Collection || $basic instanceof \think\Paginator): $i = 0; $__LIST__ = $basic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><?php echo $v['attr_name']; ?>:<?php echo $v['basic_value']; ?></td>
                            </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                </div>
            ...
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td class="jud_bg">您可对已购买商品进行评价<br /><a href="__STATIC__/index/#"><img src="__STATIC__/index/images/btn_jud.gif" /></a></td>
                    </tr>
                </table>
...
<!--[if IE 6]>
<script src="__STATIC__/index/letskillie6.googlecode.com/svn/trunk/2/zh_CN.js"></script>
<![endif]-->
...
<script type="text/javascript">
    ...
    $('.n_btn_1').click(function(){
        ...
        //number  最大时  还点击加  再点击减  再点击加  防止加不了
        if(number==stock){
    ...
    $('.n_btn_2').click(function(){
        ...
        //number=1  最小时  还点击减  再点击加  再点击减  防止减不了
        if(number<stock){
            $(this).prop('disabled',false);
        }
        $('.n_ipt').val(number);
    ...
    $('.n_ipt').blur(function(){
        var stock = $('#stock').text();
        var buy_number = parseInt ( $( '.n_ipt' ) .val() );

        if(isNaN( buy_number )){
            //手动添 纯字母汉字
            $( '.n_ipt' ) .val(1);
        }else if( buy_number > stock ){
            //手动添比库存还大 就是库存最大值
            $( '.n_ipt' ) .val(stock);
        }else if(1>buy_number){
            //手动 添 负数
            $( '.n_ipt' ) .val(1);
       }else{
            $( '.n_ipt' ) .val(buy_number);
        }
    })
    ...
    $('#car').click(function(){
        ...
        $.ajax({
            url:"<?php echo url('Car/carAdd'); ?>",
            data:'buy_number='+buy_number+'&sku_id='+"<?php echo $goods['sku_id']; ?>",
            dataType:'json',
            type:'post',
            success:function(json_info){
                if(json_info.status==100) {
                    //询问框
                    layer.confirm('添加购物车成功,是否跳转购物车列表？', {
                        title:'添加购物车',
                        icon:3,
                        btn: ['确定', '取消'] //按钮
                    }, function () {
                        //alert('跳转');
                        window.location.href="<?php echo url('Car/CarList'); ?>";
                    }, function () {
                        layer.closeAll();
                    });
                }else{
    ...
    function checkSku(){
        ...
        var cate_id="<?php echo $three['cate_id'];?>";
...
<!--[if IE 6]>
<script src="__STATIC__/index/js/zh_CN.js"></script>
<![endif]-->
</html>
